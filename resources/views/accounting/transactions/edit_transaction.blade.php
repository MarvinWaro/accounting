                    ...
                    <div class="max-w-7xl mx-auto py-8 px-10 lg:py-16">
                        ...
                        <form action="{{ route('transaction.update', $transaction->id) }}" method="POST">
                            ...
                            <div class="flex justify-end gap-4 mt-10">
                                <a href="{{ route('accounting_dashboard') }}" class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-center text-white bg-secondary-600 rounded-lg hover:bg-secondary-700 focus:ring-2 focus:ring-secondary-200 dark:text-white dark:bg-secondary-800 dark:hover:bg-secondary-900 dark:focus:ring-secondary-900">Back</a>
