                        ...
                        <li>
                            ...
                            <a href="{{ route('transaction.months', ['year' => $year]) }}" class="text-gray-900 dark:text-gray-100 hover:text-blue-700 dark:hover:text-blue-300">
                                <div class="relative isolate flex items-center justify-center overflow-hidden bg-gray-900 py-24 sm:py-32 group">
                                    ...
                                    <div class="absolute inset-0 -z-10 bg-linear-to-b from-black/70 to-gray-900/90 group-hover:from-black/90 group-hover:to-gray-900 opacity-90 transition-opacity duration-300"></div>
                                    ...
                                    <div class="mx-auto max-w-7xl px-6 lg:px-8">
                                        <h2 class="text-8xl font-bold text-transparent text-center bg-clip-text bg-linear-to-r from-white to-gray-500 sm:text-9xl transition-transform duration-300 group-hover:scale-110">{{ $year }}</h2>
                                    </div>
                                </div>
                            </a>
                        </li>
