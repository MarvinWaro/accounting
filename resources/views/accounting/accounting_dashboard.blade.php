<x-app-layout>
    ...
    <script>
      ...
      //       // Function to reinitialize Flowbite dropdowns
      ...
      //       // Call it after table initialization
      //       reinitializeDropdowns();

      //       // Listen for search input events
      //       document.querySelector("input[data-table-search]").addEventListener("input", function () {
      //             setTimeout(reinitializeDropdowns, 100); // Small delay to let the table update
      //       });

      //       // Listen for redraw (when pagination or sorting changes)
      //       dataTable.on("datatable.page", reinitializeDropdowns);
      //       dataTable.on("datatable.sort", reinitializeDropdowns);
      //    }
      // });
